package policies.auth.routes.entityReactions.updateAllEntityReactions.policy
...
test_allow_to_editor_with_field_level_permission_for_createdDateTime if {
	...
	custom_roles := [
		...
		"uma_authorization",
		"tarcinapp.editor",
		"tarcinapp.fields.entityReactions._createdDateTime.update",
	]
...
test_allow_to_editor_with_multiple_field_permissions if {
	...
	custom_roles := [
		...
		"tarcinapp.editor",
		"tarcinapp.fields.entityReactions._createdDateTime.update",
		"tarcinapp.fields.entityReactions._lastUpdatedDateTime.update",
	]
