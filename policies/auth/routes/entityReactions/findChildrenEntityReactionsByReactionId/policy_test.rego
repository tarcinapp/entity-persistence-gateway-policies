...
# Helper to construct input for finding child reactions of a parent reaction
...
test_allow_member_parent_private_active_viewer_user if {
	allow with input as produce_input(
		["tarcinapp.entityReactions.find.member"], true,
		{
			"_id": "reaction-parent-1",
			"_kind": "comment",
			"_entityId": "entity-1",
...
test_not_allow_member_missing_reactions_find_role if {
	not allow with input as produce_input(
		["tarcinapp.entities.find.member"], true,
		{
			"_id": "reaction-parent-1",
			"_kind": "comment",
			"_entityId": "entity-1",
