...
# Parent reaction visibility checks (using input.originalRecord)
...
# Related entity visibility checks (using input.originalRecord._relationMetadata)
# Based on findEntityById logic
#-----------------------------------------------
...
# Related entity visibility rules (input.originalRecord._relationMetadata)
#-----------------------------------------------
...
# Related entity visibility rules for member creation (must be ACTIVE)
#-----------------------------------------------

# For member creation, related entity must be ACTIVE (pending is not allowed)
entity_is_active_and_visible_to_member if {
	entity_is_active
