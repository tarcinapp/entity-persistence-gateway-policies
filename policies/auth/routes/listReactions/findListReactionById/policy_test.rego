...
# Tests for findListReactionById

test_allow_admin_when_verified if {
	allow with input as produce_input_doc_by_role(
		"tarcinapp.admin", true,
		{"_id": "list-1", "_validFromDateTime": "2020-01-01T00:00:00Z", "_validUntilDateTime": null, "_visibility": "public", "_ownerUsers": [], "_ownerGroups": [], "_viewerUsers": [], "_viewerGroups": []},
...
test_allow_member_owner_of_both if {
	allow with input as produce_input_doc_by_role(
		...
		{"_id": "list-1", "_validFromDateTime": "2020-01-01T00:00:00Z", "_validUntilDateTime": null, "_visibility": "protected", "_ownerUsers": ["ebe92b0c-bda2-49d0-99d0-feb538aa7db6"], "_ownerGroups": [], "_viewerUsers": [], "_viewerGroups": []},
...
test_not_allow_missing_source if {
	not allow with input as produce_input_missing_source(
		"tarcinapp.member", true,
		{"_id": "reaction-1", "_validFromDateTime": "2020-01-01T00:00:00Z", "_validUntilDateTime": null, "_visibility": "public", "_ownerUsers": [], "_ownerGroups": [], "_viewerUsers": [], "_viewerGroups": []},
	)
}
...
test_not_allow_missing_original if {
	not allow with input as produce_input_missing_original(
		"tarcinapp.member", true,
		{"_id": "list-1", "_validFromDateTime": "2020-01-01T00:00:00Z", "_validUntilDateTime": null, "_visibility": "public", "_ownerUsers": [], "_ownerGroups": [], "_viewerUsers": [], "_viewerGroups": []},
	)
}
...
# Edge cases
# Visitor cannot see a reaction that is inactive/expired even if the list is public
...
test_not_allow_member_when_source_validFrom_in_future if {
	not allow with input as produce_input_doc_by_role(
		"tarcinapp.member", true,
		{"_id": "list-1", "_validFromDateTime": "3000-01-01T00:00:00Z", "_validUntilDateTime": null, "_visibility": "public", "_ownerUsers": [], "_ownerGroups": [], "_viewerUsers": [], "_viewerGroups": []},
		{"_id": "reaction-1", "_validFromDateTime": "2020-01-01T00:00:00Z", "_validUntilDateTime": null, "_visibility": "public", "_ownerUsers": [], "_ownerGroups": [], "_viewerUsers": [], "_viewerGroups": []},
	)
}
...
test_not_allow_member_when_source_expired if {
	not allow with input as produce_input_doc_by_role(
		"tarcinapp.member", true,
		{"_id": "list-1", "_validFromDateTime": "2000-01-01T00:00:00Z", "_validUntilDateTime": "2001-01-01T00:00:00Z", "_visibility": "public", "_ownerUsers": [], "_ownerGroups": [], "_viewerUsers": [], "_viewerGroups": []},
		{"_id": "reaction-1", "_validFromDateTime": "2020-01-01T00:00:00Z", "_validUntilDateTime": null, "_visibility": "public", "_ownerUsers": [], "_ownerGroups": [], "_viewerUsers": [], "_viewerGroups": []},
	)
}
