package policies.auth.routes.listReactions.updateAllListReactions.policy
...
test_allow_to_listReactions_admin if {
...
test_allow_to_listReactions_update_admin if {
	allow with input as produce_input_doc_by_role("tarcinapp.listReactions.update.admin", true)
}
...
test_not_allow_to_listReactions_update_admin_without_email_verification if {
	not allow with input as produce_input_doc_by_role("tarcinapp.listReactions.update.admin", false)
}
...
test_allow_to_listReactions_update_admin_with_forbidden_fields if {
	forbidden_payload := object.union(base_payload, {
		"_createdDateTime": "2020-01-01T00:00:00Z",
		"_lastUpdatedDateTime": "2020-01-01T00:00:00Z",
	})
	allow with input as produce_input_doc_by_role_with_payload("tarcinapp.listReactions.update.admin", true, forbidden_payload)
}
...
test_allow_to_listReactions_editor if {
...
test_allow_to_listReactions_update_editor if {
	allow with input as produce_input_doc_by_role("tarcinapp.listReactions.update.editor", true)
}
...
test_not_allow_to_listReactions_update_editor_without_email_verification if {
	not allow with input as produce_input_doc_by_role("tarcinapp.listReactions.update.editor", false)
}
