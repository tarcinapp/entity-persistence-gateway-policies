...
can_see_related_list if {
	...
	# Admin
	list_role_utils.is_user_admin("find", input.originalRecord._relationMetadata)
	verification.is_email_verified
}
...
can_see_related_list if {
	...
	# Editor
	list_role_utils.is_user_editor("find", input.originalRecord._relationMetadata)
	verification.is_email_verified
}
...
can_see_related_list if {
	...
	# Member
	list_role_utils.is_user_member("find", input.originalRecord._relationMetadata)
	verification.is_email_verified
...
can_see_related_list if {
	...
	# Visitor
	list_role_utils.is_user_visitor("find", input.originalRecord._relationMetadata)
	verification.is_email_verified
