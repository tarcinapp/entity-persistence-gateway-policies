# Find Children List Reactions By Reaction Id Policy

## Description

This policy evaluates the user's role, email verification status, and the visibility of the parent list reaction (`originalRecord`) to decide if querying child reactions is allowed.
...
- `originalRecord`: The parent list reaction record whose children are being queried.
