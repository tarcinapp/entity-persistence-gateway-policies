package policies.auth.routes.listReactions.findChildrenListReactionsByReactionId.policy

import data.policies.util.common.test as test

# Helper to construct input for finding child list reactions of a parent reaction
...
test_allow_admin_parent_private_viewer_user if {
	allow with input as produce_input(
...
test_allow_member_parent_private_active_viewer_user if {
	allow with input as produce_input(
...
test_allow_member_parent_group_owned_protected_active if {
	allow with input as produce_input(
...
test_allow_member_parent_public_active if {
	allow with input as produce_input(
		["tarcinapp.reactions.find.member"], true,
		{
			"_id": "list-reaction-parent-1",
...
### Visitor roles
test_allow_visitor_parent_public_active if {
	allow with input as produce_input(
...
test_not_allow_admin_parent_private_not_viewable if {
	not allow with input as produce_input(
		["tarcinapp.admin"], true,
		{
			"_id": "list-reaction-parent-1",
...
test_not_allow_editor_parent_private_not_viewable if {
	not allow with input as produce_input(
		["tarcinapp.reactions.find.editor"], true,
		{
			"_id": "list-reaction-parent-1",
...
test_not_allow_member_parent_private_not_viewable if {
	not allow with input as produce_input(
		["tarcinapp.reactions.find.member"], true,
		{
			"_id": "list-reaction-parent-1",
...
### Visitor roles
test_not_allow_visitor_parent_private if {
	not allow with input as produce_input(
		["tarcinapp.reactions.find.visitor"], true,
		{
			"_id": "list-reaction-parent-1",
...
test_not_allow_visitor_parent_expired if {
	not allow with input as produce_input(
		["tarcinapp.reactions.find.visitor"], true,
		{
			"_id": "list-reaction-parent-1",
