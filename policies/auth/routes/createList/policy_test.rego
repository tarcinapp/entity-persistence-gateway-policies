...
test_allow_to_lists_member_with_createdBy_field_permission if {
    allow with input as produce_input_doc_by_role_with_field_permission("tarcinapp.lists.member", true, {
        "_name": "Test List",
        "description": "Test Description",
        "_visibility": "public",
        "_createdBy": "some-user"  # This should be allowed due to field-level permission
...
test_allow_to_lists_create_member_with_createdBy_field_permission if {
    allow with input as produce_input_doc_by_role_with_field_permission("tarcinapp.lists.create.member", true, {
        "_name": "Test List",
        "description": "Test Description",
        "_visibility": "public",
        "_createdBy": "some-user"  # This should be allowed due to field-level permission
...
test_allow_to_global_member_with_creationDateTime_field_permission if {
    ...
    }, "tarcinapp.lists.fields._creationDateTime.create")
}
...
# Test _creationDateTime field access for lists scope member with field-level create permission
test_allow_to_lists_member_with_creationDateTime_field_permission if {
    allow with input as produce_input_doc_by_role_with_field_permission("tarcinapp.lists.member", true, {
        "_name": "Test List",
        "description": "Test Description",
        "_visibility": "public",
...
# Test _creationDateTime field access for lists create operation member with field-level create permission
test_allow_to_lists_create_member_with_creationDateTime_field_permission if {
    allow with input as produce_input_doc_by_role_with_field_permission("tarcinapp.lists.create.member", true, {
        "_name": "Test List",
        "description": "Test Description",
        "_visibility": "public",
...
test_allow_to_lists_editor_with_createdBy_field_permission if {
    allow with input as produce_input_doc_by_role_with_field_permission("tarcinapp.lists.editor", true, {
        "_name": "Test List",
        "description": "Test Description",
        "_visibility": "public",
        "_createdBy": "some-user"  # This should be allowed due to field-level permission
...
test_allow_to_lists_create_editor_with_createdBy_field_permission if {
    allow with input as produce_input_doc_by_role_with_field_permission("tarcinapp.lists.create.editor", true, {
        "_name": "Test List",
        "description": "Test Description",
        "_visibility": "public",
        "_createdBy": "some-user"  # This should be allowed due to field-level permission
...
test_not_allow_to_lists_visitor_with_createdBy_field_permission if {
    not allow with input as produce_input_doc_by_role_with_field_permission("tarcinapp.lists.visitor", true, {
        "_name": "Test List",
        "description": "Test Description",
        "_visibility": "public",
        "_createdBy": "some-user"  # Should still be denied - visitors cannot create
...
test_not_allow_to_lists_create_visitor_with_createdBy_field_permission if {
    not allow with input as produce_input_doc_by_role_with_field_permission("tarcinapp.lists.create.visitor", true, {
        "_name": "Test List",
        "description": "Test Description",
        "_visibility": "public",
        "_createdBy": "some-user"  # Should still be denied - visitors cannot create
...
test_not_allow_to_lists_member_with_entities_scope_field_permission if {
    not allow with input as produce_input_doc_by_role_with_field_permission("tarcinapp.lists.member", true, {
        "_name": "Test List",
        "description": "Test Description",
        "_visibility": "public",
        "_createdBy": "some-user"  # Should be denied - wrong scope (entities vs lists)
