...
test_allow_to_entities_update_editor if {
    allow with input as produce_input_doc_by_role("tarcinapp.entities.update.editor", true)
}
...
test_not_allow_to_entities_update_admin_without_email_verification if {
    not allow with input as produce_input_doc_by_role("tarcinapp.entities.update.admin", false)
}
...
test_allow_to_entities_update_admin_with_forbidden_fields if {
    ...
    allow with input as produce_input_doc_by_role_with_payload("tarcinapp.entities.update.admin", true, forbidden_payload)
}
...
test_allow_to_editor_with_field_level_manage_permission_for_creationDateTime if {
    ...
    custom_roles := [
        ...
        "uma_authorization",
        "tarcinapp.editor",
        "tarcinapp.entities.fields._creationDateTime.manage"
    ]
...
test_allow_to_entities_editor_with_entities_scope if {
    # User has entities scope editor role
    allow with input as produce_input_doc_by_role("tarcinapp.entities.editor", true)
}

test_not_allow_to_lists_editor_with_lists_scope if {
    # User has lists scope editor role but trying to update entities
...
test_not_allow_to_reactions_editor_with_reactions_scope if {
    # User has reactions scope editor role but trying to update entities
...
test_not_allow_to_editor_with_find_only_field_permission if {
    ...
    custom_roles := [
        ...
        "uma_authorization",
        "tarcinapp.editor",
        "tarcinapp.entities.fields._creationDateTime.find"  # Only find, not update
    ]
...
test_not_allow_to_editor_with_create_only_field_permission if {
    ...
    custom_roles := [
        ...
        "uma_authorization",
        "tarcinapp.editor",
        "tarcinapp.entities.fields._creationDateTime.create"  # Only create, not update
    ]
