...
test_allow_actives_to_owner if {
	allow with input as produce_input(
		false, ["tarcinapp.member"], ["users-group-1"],
	...
	allow with input as produce_input(
		false, ["tarcinapp.entities.member"], ["users-group-1"],
		["ebe92b0c-bda2-49d0-99d0-feb538aa7db6"],
		["any-owner-group-1"],
		"private",
		"2020-01-01T00:00:00Z",
	...
	allow with input as produce_input(
		false, ["tarcinapp.records.member"], ["users-group-1"],
		["ebe92b0c-bda2-49d0-99d0-feb538aa7db6"],
		["any-owner-group-1"],
		"protected",
		"2020-01-01T00:00:00Z",
...
test_allow_active_record_with_user_in_viewerUsers if {
	allow with input as produce_input_with_viewerUsers(
		false, ["tarcinapp.member"], ["users-group-1"],
		["any-owner-user"],
		["any-owner-group-1"],
		"private",
...
test_not_allow_inactive_record_with_user_in_viewerUsers if {
	not allow with input as produce_input_with_viewerUsers(
		false, ["tarcinapp.member"], ["users-group-1"],
		["any-owner-user"],
		["any-owner-group-1"],
		"private",
...
test_allow_active_protected_record_with_user_group_in_viewerGroups if {
	allow with input as produce_input_with_viewerGroups(
		false, ["tarcinapp.member"], ["users-group-1"],
		["any-owner-user"],
		["any-owner-group-1"],
		"protected",
...
test_not_allow_active_private_record_with_user_group_in_viewerGroups if {
	not allow with input as produce_input_with_viewerGroups(
		false, ["tarcinapp.member"], ["users-group-1"],
		["any-owner-user"],
		["any-owner-group-1"],
		"private",
...
test_allow_active_public_to_visitor if {
	allow with input as produce_input(
		false, ["tarcinapp.visitor"], ["users-group-1"],
		["any-owner-user"],
		["any-owner-group-1"],
		"public",
		"2020-01-01T00:00:00Z",
