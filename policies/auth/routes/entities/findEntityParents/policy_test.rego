package policies.auth.routes.entities.findEntityParents.policy
...
test_allow_inactives_to_admin if {
	...
	allow with input as produce_input(false, ["tarcinapp.entities.admin"], ["any-group-1"], ["any-owner"], ["any-owner-group-1"], "public", "2020-01-01T00:00:00Z", "2021-01-01T00:00:00Z")

	allow with input as produce_input(false, ["tarcinapp.entities.admin"], ["any-group-1"], ["any-owner"], ["any-owner-group-1"], "private", "2020-01-01T00:00:00Z", "2021-01-01T00:00:00Z")

	allow with input as produce_input(false, ["tarcinapp.entities.find.admin"], ["any-group-1"], ["any-owner"], ["any-owner-group-1"], "private", "2020-01-01T00:00:00Z", "2021-01-01T00:00:00Z")
...
test_allow_active_record_with_user_in_viewerUsers if {
    allow with input as produce_input_with_viewerUsers(false, ["tarcinapp.member"], ["users-group-1"], 
        ["any-owner-user"],
        ["any-owner-group-1"],
        "private",
        "2020-01-01T00:00:00Z",
...
test_not_allow_inactive_record_with_user_in_viewerUsers if {
    not allow with input as produce_input_with_viewerUsers(false, ["tarcinapp.member"], ["users-group-1"], 
        ["any-owner-user"],
        ["any-owner-group-1"],
        "private",
        "2020-01-01T00:00:00Z",
...
test_allow_active_protected_record_with_user_group_in_viewerGroups if {
    allow with input as produce_input_with_viewerGroups(false, ["tarcinapp.member"], ["users-group-1"], 
        ["any-owner-user"],
        ["any-owner-group-1"],
        "protected",
        "2020-01-01T00:00:00Z",
...
test_not_allow_active_private_record_with_user_group_in_viewerGroups if {
    not allow with input as produce_input_with_viewerGroups(false, ["tarcinapp.member"], ["users-group-1"], 
        ["any-owner-user"],
        ["any-owner-group-1"],
        "private",
        "2020-01-01T00:00:00Z",
...
test_allow_active_public_to_visitor if {
    allow with input as produce_input(false, ["tarcinapp.visitor"], ["users-group-1"], 
        ["any-owner-user"],
        ["any-owner-group-1"],
        "public",
        "2020-01-01T00:00:00Z",
...
test_not_allow_active_protected_to_visitor if {
    not allow with input as produce_input(false, ["tarcinapp.visitor"], ["users-group-1"], 
        ["any-owner-user"],
        ["any-owner-group-1"],
        "protected",
        "2020-01-01T00:00:00Z",
...
produce_input(verified, roles, groups, ownerUsers, ownerGroups, visibility, validFrom, validUntil) = test_body if {
	test_body = {
		...
		"httpMethod": "GET",
		"requestPath": "/entities/123/parents",
		"queryParams": {},
