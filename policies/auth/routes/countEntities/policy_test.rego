...
test_allow_admin if {
    ...
    allow with input as produce_input_doc_by_role("tarcinapp.entities.count.admin", true)
}
...
test_allow_editor if {
    ...
    allow with input as produce_input_doc_by_role("tarcinapp.entities.count.editor", true)
}
...
test_allow_member if {
    ...
    allow with input as produce_input_doc_by_role("tarcinapp.entities.count.member", true)
}
...
test_allow_visitor if {
    ...
    allow with input as produce_input_doc_by_role("tarcinapp.entities.count.visitor", true)
}
...
test_not_allow_member if {
    ...
    not allow with input as produce_input_doc_by_role("tarcinapp.entities.count.member", false)
}
...
test_not_allow_visitor if {
    ...
    not allow with input as produce_input_doc_by_role("tarcinapp.entities.count.visitor", false)
}
