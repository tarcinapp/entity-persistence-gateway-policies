...
test_allow_to_global_admin if {
	allow with input as produce_input_by_role(
		["tarcinapp.admin"], true, ["group-1"], {
			"_name": "Test Entity",
...
test_allow_to_member_when_owner_user_and_list_private if {
	allow with input as produce_input_by_role(
		["tarcinapp.member"], true, ["users-group-1"], {
			"_name": "Test Entity",
			"description": "Test Description",
			"_visibility": "public",
		},
...
test_allow_field_level_permission_allows_forbidden_field if {
	allow with input as produce_input_by_role_with_field_permission(
		["tarcinapp.member"], true, ["group-1"], {
			"_name": "Test Entity",
			"description": "Test Description",
			"_visibility": "public",
...
test_not_allow_visitor_even_if_list_public if {
	not allow with input as produce_input_by_role(
		["tarcinapp.visitor"], true, ["group-1"], {
			"_name": "Test Entity",
			"description": "Test Description",
			"_visibility": "public",
		},
...
test_not_allow_member_without_email_verification if {
	not allow with input as produce_input_by_role(
		["tarcinapp.member"], false, ["group-1"], {
			"_name": "Test Entity",
			"description": "Test Description",
			"_visibility": "public",
		},
