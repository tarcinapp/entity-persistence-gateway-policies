package policies.auth.routes.reactionsThroughList.deleteReactionsByListId.policy
...
test_allow_to_listReactions_delete_admin if {
	allow with input as produce_input_doc_by_role("tarcinapp.listReactions.delete.admin", true)
}
...
test_not_allow_to_listReactions_editor if {
	not allow with input as produce_input_doc_by_role("tarcinapp.listReactions.editor", true)
}
