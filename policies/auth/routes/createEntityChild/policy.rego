package policies.auth.routes.createEntityChild.policy
...
# User can see parent record checks (same logic as findEntityById)
#-----------------------------------------------
...
# Visitors are not allowed to create entity children (no visitor allow rule)
# Note: Even if a visitor can see a public active parent entity, they cannot create children

#-----------------------------------------------

# Creation validation helpers (same logic as createEntity)
#-----------------------------------------------
