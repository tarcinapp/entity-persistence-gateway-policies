...
test_allow_to_editor_with_field_level_manage_permission_for_createdDateTime if {
	...
	custom_roles := [
		...
		"uma_authorization",
		"tarcinapp.editor",
		"tarcinapp.fields.lists._createdDateTime.manage",
	]
...
test_allow_to_editor_with_field_level_permission_for_lastUpdatedDateTime if {
	...
	custom_roles := [
		...
		"uma_authorization",
		"tarcinapp.editor",
		"tarcinapp.fields.lists._lastUpdatedDateTime.update",
	]
...
test_not_allow_to_editor_with_find_only_field_permission if {
	...
	custom_roles := [
		...
		"uma_authorization",
		"tarcinapp.editor",
		"tarcinapp.fields.lists._createdDateTime.find", # Only find, not update
	]
...
test_not_allow_to_editor_with_create_only_field_permission if {
	...
	custom_roles := [
		...
		"uma_authorization",
		"tarcinapp.editor",
		"tarcinapp.fields.lists._createdDateTime.create", # Only create, not update
	]
