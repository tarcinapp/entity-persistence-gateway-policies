...
test_allow_to_admin if {
    ...
    allow 
        with input as produce_input_doc_by_role(["tarcinapp.relations.admin"])

    allow 
        with input as produce_input_doc_by_role(["tarcinapp.records.update.admin"])

    allow 
        with input as produce_input_doc_by_role(["tarcinapp.relations.update.admin"])
}
