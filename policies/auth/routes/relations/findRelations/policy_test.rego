package policies.auth.routes.relations.findRelations.policy
...
test_allow_admin if {
    ...
    allow with input as produce_input_doc_by_role("tarcinapp.relations.find.admin", true)
}
...
test_allow_editor if {
    ...
    allow with input as produce_input_doc_by_role("tarcinapp.relations.find.editor", true)
}
...
test_allow_member if {
    ...
    allow with input as produce_input_doc_by_role("tarcinapp.relations.find.member", true)
}
...
test_allow_visitor if {
    ...
    allow with input as produce_input_doc_by_role("tarcinapp.relations.find.visitor", true)
}
...
test_not_allow_member if {
    ...
    not allow with input as produce_input_doc_by_role("tarcinapp.relations.find.member", false)
}
...
test_not_allow_visitor if {
    ...
    not allow with input as produce_input_doc_by_role("tarcinapp.relations.find.visitor", false)
}
...
test_not_allow_other_roles if {
    ...
    not allow with input as produce_input_doc_by_role("tarcinapp.relations.count.admin", true)
    ...
    not allow with input as produce_input_doc_by_role("tarcinapp.relations.count.editor", true)
    ...
    not allow with input as produce_input_doc_by_role("tarcinapp.relations.count.member", true)
