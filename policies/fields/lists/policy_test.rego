...
test_editor_creationDateTime_create {
	...
	which_fields_forbidden_for_create = ["lastUpdatedDateTime", "lastUpdatedBy", "createdBy"] with input as produce_input_doc_by_role(["tarcinapp.editor", "tarcinapp.lists.fields.creationDateTime.manage"])

	which_fields_forbidden_for_create = ["lastUpdatedDateTime", "lastUpdatedBy", "createdBy"] with input as produce_input_doc_by_role(["tarcinapp.editor", "tarcinapp.lists.fields.creationDateTime.create"])

	which_fields_forbidden_for_create = ["creationDateTime", "lastUpdatedDateTime", "lastUpdatedBy", "createdBy"] with input as produce_input_doc_by_role(["tarcinapp.editor", "tarcinapp.lists.fields.creationDateTime.find"])

	which_fields_forbidden_for_create = ["creationDateTime", "lastUpdatedDateTime", "lastUpdatedBy", "createdBy"] with input as produce_input_doc_by_role(["tarcinapp.editor", "tarcinapp.lists.fields.visibility.create"])
}
