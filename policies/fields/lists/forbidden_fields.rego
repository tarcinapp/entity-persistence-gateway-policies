...
default forbiddenFields := [
	...
	},
	{
		...
		"operations": {
			...
			"update": ["_kind", "_listId", "_createdDateTime", "_lastUpdatedDateTime", "_lastUpdatedBy", "_createdBy", "_validFromDateTime", "_validUntilDateTime"], # valid until is added as it requires additional role to inactivate the record for members
		},
	},
	{
		"role": "visitor",
